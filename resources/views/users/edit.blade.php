            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                <div class="space-y-2">
                    ...
                    <select name="approval_level" id="approval_level" required
                        ...
                        <option value="1" {{ old('approval_level', $user->approval_level) == 1 ? 'selected' : '' }}>Level 1 — Operational / Field Auditor</option>
                        <option value="2" {{ old('approval_level', $user->approval_level) == 2 ? 'selected' : '' }}>Level 2 — Senior Auditor / Supervisory Reviewer</option>
                        <option value="3" {{ old('approval_level', $user->approval_level) == 3 ? 'selected' : '' }}>Level 3 — Audit Manager / Chief Internal Auditor</option>
                        <option value="4" {{ old('approval_level', $user->approval_level) == 4 ? 'selected' : '' }}>Level 4 — Executive / Audit Committee / Council</option>
                        <option value="5" {{ old('approval_level', $user->approval_level) == 5 ? 'selected' : '' }}>Level 5 — System Administrator</option>
                    </select>
